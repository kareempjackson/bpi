  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className={`relative w-full max-w-5xl max-h-[92vh] overflow-y-auto rounded-3xl px-4 pt-16 pb-5 md:px-8 md:pt-20 md:pb-8 lg:px-12 lg:pt-20 lg:pb-12 transition-all duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      >
        ...
        <div
          className="relative rounded-2xl p-4 md:p-7 lg:p-9 grid grid-cols-1 md:grid-cols-[44%_1fr] gap-5 lg:gap-9"
        ...
        >
          ...
          <div className="flex flex-col py-2 md:py-4 lg:py-6">
            ...
            {bio ? (
              <p className="mt-6 lg:mt-10 text-sm md:text-base lg:text-md text-primary-500/85 leading-relaxed whitespace-pre-line">
                {bio}
              </p>
            ) : null}
          </div>
