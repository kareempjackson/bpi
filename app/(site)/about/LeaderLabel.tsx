  ...
  return (
    <>
      <div className={`absolute ${className}`}>
        <div className="transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-1 motion-reduce:transform-none will-change-transform">
