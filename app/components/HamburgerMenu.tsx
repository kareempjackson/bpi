    ...
    >
      ...
      >
        ...
        <path
          ...
          style={{ fill: "var(--brand-accent, #06fe83)" }}
        />
        ...
        <circle
          ...
          cy="27"
          r="21"
          style={{ fill: "var(--brand-accent-strong, #04b25c)" }}
          className="origin-center transform-fill scale-0 transition-transform duration-400 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:scale-100"
        />
