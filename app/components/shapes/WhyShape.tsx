...
export default function WhyShape({
  ...
  // Wrap the SVG in an aspect-ratio div so Safari derives the height
  // from the viewBox aspect (it otherwise falls back to the SVG's
  // intrinsic pixel height when `height: auto` is used).
  return (
    <div
