      ...
      <ul ref={listRef} data-reveal-stagger className="flex flex-col">
        {initiatives.map((item, idx) => {
          ...
          return (
            ...
            >
              <div className="col-span-12 md:col-span-5 text-base lg:text-[22px] font-light text-primary-500 leading-[1.2] tracking-normal line-clamp-1">
                {item.title}
              </div>
              <p className="col-span-12 md:col-span-7 text-sm lg:text-base font-light text-primary-500/80 leading-normal tracking-normal">
                {item.description}
              </p>
            </li>
          );
