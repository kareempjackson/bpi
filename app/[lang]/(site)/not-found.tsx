...
/**
 * Catch-all 404 for the (site) route group. Next.js automatically renders
 * this file when a request inside the group doesn't match any segment, so
 * any "broken" or not-yet-built link on the site lands here. Styled to
 * match the brand voice rather than the standard Next default screen.
 */
export default function NotFound() {
  return (
    <main className="relative bg-error-25 overflow-hidden min-h-[calc(100vh-160px)] flex items-center">
      {/* Soft icon watermark, matching the careers / footer treatment. */}
      <div
        aria-hidden
